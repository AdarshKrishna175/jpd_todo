...
def register(request):
    ...
    if request.method == 'POST':
        ...
        print(username, password, name, gender, phone, dob)

        try:
            cursor = connection.cursor()
            sql = "insert into users value(null, %s, %s, %s, %s, %s, %s )"
...
def todo(request):
    'show todos'
    # Rediresct to home page if not logged in 
